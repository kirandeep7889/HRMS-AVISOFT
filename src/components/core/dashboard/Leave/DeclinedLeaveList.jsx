                ...
                <tbody>
                  {declinedLeaves.map((leave, index) => (
                    <tr key={index} className=''>
                      ...
                      <td className="py-2 px-4 border-b border-slate-200 text-red-600 ">Declined</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ) : (
              <div className='flex items-center justify-center'><p className='text-xl font-semibold text-zinc-700'>No declined leave requests.....</p></div>
            )}
          </div>
        </div>
      )}
