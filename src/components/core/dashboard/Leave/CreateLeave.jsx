...
const CreateLeave = () => {
  ...
  const onSubmit = data => {
    console.log(data);
    const response=dispatch(createLeave(employeeId,data,AccessToken,navigate));
  };
  ...
  return (
    <div className='pb-9 bg-slate-100 rounded-md mb-5 '>
     ...
     <form className='p-5' data-testid="create-leave-form" onSubmit={handleSubmit(onSubmit)}>
        <div className="grid grid-cols-2 gap-4">
          <div className="mt-4">
            <label htmlFor="leaveType" className="block text-sm font-semibold text-slate-900 mb-1">
            ...
            {errors.leaveType && <span className="text-red-600">This field is required</span>}
          </div>
          <div className="mt-4">
            <label htmlFor="numberOfDays" className="block text-sm font-semibold text-slate-900 mb-1">
            ...
            />
            {errors.numberOfDays && <span className="text-red-600">This field is required and must be at least 1 day</span>}
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4">
          <div className="mt-4">
            <label htmlFor="startDate" className="block text-sm font-semibold text-slate-900 mb-1">
          ...
          <div className="mt-4">
            <label htmlFor="endDate" className="block text-sm font-semibold text-slate-900 mb-1">
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          <div className="mt-4">
            <label htmlFor="leaveDetails" className="block text-sm font-semibold text-slate-900 mb-1">
            ...
            ></textarea>
            {errors.leaveDetails && <span className="text-red-600">This field is required</span>}
          </div>
        </div>
