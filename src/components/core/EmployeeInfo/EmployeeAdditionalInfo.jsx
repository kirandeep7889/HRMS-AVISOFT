...
const EmployeeAdditionalInfo = ({ user }) => {
    ...
    const additionalDetails = [
        {
            name: 'Department',
            value: user?.department?.department || <p className='text-pink-600'>Add Department</p>,
        },
        {
            name: 'Position',
        ...
        {
            name: 'Employee Code',
            value: user?.employeeCode || <p className='text-pink-600'>Add Employee Code</p>,
        },
        {
            name: 'Role',
        ...
        {
            name: 'Aadhar Number',
            value: user.adhaarNumber || <p className='text-pink-600'>Add Aadhar Number</p>,
        },
        {
            name: 'PAN Number',
